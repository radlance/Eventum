...
import com.radlance.eventum.navigation.base.OnboardingFirst
import com.radlance.eventum.navigation.base.OnboardingSecond
import com.radlance.eventum.navigation.base.OnboardingThird
import com.radlance.eventum.navigation.base.SignIn
import com.radlance.eventum.navigation.base.Splash
...
class OnBoardingTest {
    ...
    fun setupNavHost() {
        composeTestRule.setContent {
            ...
            NavGraph(
                ...
                sharedViewModel = viewModelFactory.createEventViewModel()
            )
        }
    }
    ...
    fun navHost_onBoardingSwipe_popUpOnboardingScreensStack() {
        val onBoardingScreens = listOf(
            OnboardingScreen(
                stringResId = R.string.choose_what_you_like,
